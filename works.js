...
const portfolioData = [
  {
    ...
    year1: '2023',
    year2: '2023',
    description1: 'A mobile web application that allows Gamers all around the world to track their spendings on games.',
    description2: 'A mobile web application that allows Gamers all around the world to track their spendings on games.',
    technologies: ['Ruby on Rails', 'css3'],
    imageMobile: 'assets/works-snapshot/Snapshoot Portfolio 6.png',
    imageDesktop: 'assets/desktop/Desktop-work-snapshot-55.png',
    modalImage: 'assets/desktop/modal/modal-work-snapshot-6.jpg',
    dotImage: 'assets/mobile/dot.png',
    paragraph: 'GameXpense is a mobile web application that allows Gamers all around the world to track their spendings on games. It gives the user the opportunity to categorize spendings according to Games and get a useful information like the total amount spent etc.Now Gamers will know their exact expenses on a single platform.',
    liveLink: 'location.href="https://stocksgenie.netlify.app/"',
    sourceLink: 'location.href="https://github.com/frempongdev/company-stock-app"',
  },
  {
    title: 'World Stocks Genie',
    title2: 'World Stocks Genie',
    company: 'Personal',
    company2: 'Personal',
    role1: 'Front-End Dev',
    role2: 'Front-End Dev',
    ...
    dotImage: 'assets/mobile/dot.png',
    paragraph: 'A Single Page Application for stock investors and anyone else interested in the prices of stocks in the Global Stocks market. It fetches real-time stock prices from the Financial Modeling Prep API together with other details of the companies.',
    liveLink: 'location.href="https://stocksgenie.netlify.app/"',
    sourceLink: 'location.href="https://github.com/frempongdev/company-stock-app"',
  },
  {
    title: 'Fifa 23 Leaderboard',
    title2: 'Fifa 23 Leaderboard',
    company: 'Personal',
    company2: 'Personal',
    role1: 'Front-End Dev',
    role2: 'Front-End Dev',
    ...
    year1: '2023',
    year2: '2023',
    description1: 'An application that is used by Gamers to save and rank their scores.',
    description2: 'An application that is used by Gamers to save and rank their scores.',
    ...
    liveLink: 'location.href="https://frempongdev.github.io/Leaderboard/dist/"',
    sourceLink: 'location.href="https://github.com/frempongdev/Leaderboard"',
  },
  {
    title: 'Math Magician',
    title2: 'Math Magician',
    company: 'Personal',
    company2: 'Personal',
    role1: 'Full Stack Dev',
    role2: 'Full Stack Dev',
    ...
    dotImage: 'assets/mobile/dot.png',
    paragraph: 'Math Magician is a project that merges the idea of math and mathematical quotes. The Application displays a tab that does basic calculator operations and another tab that displays mathematical quotes.',
    liveLink: 'location.href="https://math-magician-46yv.onrender.com/"',
    sourceLink: 'location.href="https://github.com/frempongdev/Math-Magician"',
  },
  {
    title: 'Mini Phone Shop',
    title2: 'Mini Phone Shop',
    company: 'Personal',
    company2: 'Personal',
    role1: 'Front-End Dev',
    role2: 'Front-End Dev',
    ...
    dotImage: 'assets/mobile/dot.png',
    paragraph1: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    paragraph: 'A mini Android Phone Shop that users can Add phones fetched from an API to their cart. Page also has a price and total element that displays phone prices and the total of the prices added to the cart.',
    liveLink: 'location.href="https://mini-android-shop.netlify.app/"',
    sourceLink: 'location.href="https://github.com/frempongdev/Mini-Android-Shop-App"',
  },
  {
